$(document).ready(function () {
  ...
  //code for displaying the current date in the header of the page
  var presentDate = dayjs().format('MMM D, YYYY, hh:mm:ss a')
  $('#currentDay').text(presentDate);

});

//code to apply the past, present or future classes to each time block and display color accordingly
  $('.description').each(function() {
    ...
    //function to save the input into local storage and to gey any user input that was saved in localStorage and set
